...
def test_orchestrator_planning():
    ...
    print("\n📋 Test Case 1: Analyze PDF and find trials")
    ...
    print("   ✅ Correct workflow planned")
    
    # Test Case 2: Just find trials (no PDF)
    print("\n📋 Test Case 2: Direct trial search")
    ...
    print("\n📋 Test Case 4: Workflow progression")
    ...
    print("   ✅ Workflow progression working correctly")
